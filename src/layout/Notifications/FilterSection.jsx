...
function FilterSection({ selectedFilter, setSelectedFilter }) {
    ...
    return (
        ...
        >
            ...
            <motion.button layout onClick={() => handleChangeFilter("administrator")} style={{ background: selectedFilter === "administrator" ? "#6C5DD3" : "transparent", color: selectedFilter === "administrator" ? "#fff" : "unset", border: selectedFilter === "administrator" ? "2px solid transparent" : "2px solid #ff754c" }}>{translation.administrator}</motion.button>
